...
// SEC·D — portal actions ride the SAME hash chain as everything else;
// a raw INSERT here was a second door producing unhashed rows, caught
// by the chain-verification test the day it shipped.
const audit = (portal, action, entityId, meta = null) =>
  logAuditSystem({ actorName: `portal:${portal.vendorName}`, action, entity: "deliverables", entityId, meta }).catch(() => {});
