-- Pulse (نبض) — one-shot setup: schema + generic seed.
-- Generated by concatenating schema.sql + seed.sql. Do not edit by hand;
-- rebuild after ANY schema change or the test harness silently drifts.
